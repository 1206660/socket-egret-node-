...
__reflect(Downloader.prototype, "Downloader");
...
__reflect(MultiTaskManager.prototype, "MultiTaskManager");
...
__reflect(DownloadManager.prototype, "DownloadManager");
...
__reflect(UnzipManager.prototype, "UnzipManager");
...
__reflect(InstallSDK.prototype, "InstallSDK");
(function () {
    var isEgret = isInEgretMode();
    if (!isEgret) {
