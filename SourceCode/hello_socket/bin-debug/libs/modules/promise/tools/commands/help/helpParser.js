 ...
 */
var help_def_set = require("./helpConfig");
...
__reflect(HelpDefParserKey.prototype, "HelpDefParserKey");
...
__reflect(CfgParaType.prototype, "CfgParaType");
...
__reflect(DetailBody.prototype, "DetailBody");
...
(function (help) {
    function logHelpDef(command) {
        ...
        for (var i = 0; i < aConfig.length; ++i) {
            ...
            aFormCollection.push(getFwco(sPrefix + sName + (fwcoSubLv1.length ? space + fwcoSubLv1 : ''), bOptional));
        }
        /// 配置说明元素暂存数组
        ...
        for (var i = 0; i < aDetailBody.length; ++i) {
            ...
            aDetailCollection.push(detailBody.joinWithSpaceAlign(iWordLenMax + GAP_WORD_AND_ITS_DESC));
        }
        //// 用法 缓冲集合
